package mamba.metricsservice.metrics.timeline.aggregators.v2;

import mamba.metricsservice.metrics.timeline.PhoenixHBaseAccessor;
import mamba.metricsservice.metrics.timeline.aggregators.AbstractTimelineAggregator;
import mamba.metricsservice.metrics.timeline.query.Condition;
import mamba.metricsservice.metrics.timeline.query.EmptyCondition;
...
import static mamba.metricsservice.metrics.timeline.query.PhoenixTransactSQL.GET_AGGREGATED_APP_METRIC_GROUPBY_SQL;
import static mamba.metricsservice.metrics.timeline.query.PhoenixTransactSQL.METRICS_CLUSTER_AGGREGATE_TABLE_NAME;

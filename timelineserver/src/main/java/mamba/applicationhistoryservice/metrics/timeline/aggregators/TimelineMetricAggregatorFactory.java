...
import mamba.applicationhistoryservice.metrics.timeline.aggregators.v2.TimelineMetricClusterAggregator;
import mamba.applicationhistoryservice.metrics.timeline.aggregators.v2.TimelineMetricHostAggregator;
...
import static mamba.applicationhistoryservice.metrics.timeline.query.PhoenixTransactSQL.*;
...
public class TimelineMetricAggregatorFactory {
    ...
    public static TimelineMetricAggregator createTimelineMetricAggregatorMinute(PhoenixHBaseAccessor hBaseAccessor, Configuration metricsConf) {
        ...
        if (useGroupByAggregator(metricsConf)) {
            return new mamba.applicationhistoryservice.metrics.timeline.aggregators.v2.TimelineMetricHostAggregator(
    ...
    public static TimelineMetricAggregator createTimelineClusterAggregatorMinute(
        ...
        if (useGroupByAggregator(metricsConf)) {
            return new mamba.applicationhistoryservice.metrics.timeline.aggregators.v2.TimelineMetricClusterAggregator(

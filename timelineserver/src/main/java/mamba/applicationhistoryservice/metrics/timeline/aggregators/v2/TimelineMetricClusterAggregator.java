package mamba.applicationhistoryservice.metrics.timeline.aggregators.v2;

import mamba.applicationhistoryservice.metrics.timeline.PhoenixHBaseAccessor;
import mamba.applicationhistoryservice.metrics.timeline.aggregators.AbstractTimelineAggregator;
import mamba.applicationhistoryservice.metrics.timeline.query.Condition;
import mamba.applicationhistoryservice.metrics.timeline.query.EmptyCondition;
...
import static mamba.applicationhistoryservice.metrics.timeline.query.PhoenixTransactSQL.GET_AGGREGATED_APP_METRIC_GROUPBY_SQL;
import static mamba.applicationhistoryservice.metrics.timeline.query.PhoenixTransactSQL.METRICS_CLUSTER_AGGREGATE_TABLE_NAME;
